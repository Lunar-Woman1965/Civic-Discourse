...
export default function LandingPage() {
  const structuredData = {
    ...
    description:
      'A social media platform where people of all political affiliations engage in civil political discussions about climate change, healthcare, economy, immigration, and more',
    url: 'https://civic-discourse-production.up.railway.app',
    potentialAction: {
      '@type': 'SearchAction',
      target: {
        '@type': 'EntryPoint',
        urlTemplate:
          'https://civic-discourse-production.up.railway.app/search?q={search_term_string}',
      },
    ...
    keywords:
      'political discussion, all political views, political spectrum, climate change, healthcare policy, economic policy, civil discourse, bipartisan, political forum',
  }
  ...
  const organizationData = {
    ...
    name: 'Bridging the Aisle',
    description:
      'A social media platform bringing people of all political affiliations together for civil political discussions on climate change, healthcare, economy, and more',
    url: 'https://civic-discourse-production.up.railway.app',
    logo: 'https://civic-discourse-production.up.railway.app/bridging-the-aisle-logo.png',
    sameAs: [
  ...
  const webApplicationData = {
    ...
    name: 'Bridging the Aisle',
    description:
      'Join people of all political affiliations and perspectives in respectful, fact-based political discourse on climate change, healthcare, economy, immigration, education, and foreign policy',
    url: 'https://civic-discourse-production.up.railway.app',
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-creamy-tan-50 to-creamy-tan-200">
              ...
              <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  ...
                  >
                    ...
                    <span className="block text-turquoise-600 xl:inline">
                      Where All Political Voices Meet
                    </span>
                  </motion.h1>
                  ...
                  >
                    Join a community dedicated to respectful, fact-based political discourse.
                    Discuss climate change, healthcare policy, economic reform, and more with
                    people of all political perspectives across the entire spectrum in meaningful
                    conversations.
                  </motion.p>
                  ...
                  >
                    <strong>Ages 18+:</strong> You must be at least 18 years old to join our
                    platform.
                  </motion.p>
                    ...
                    <Alert className="bg-blue-50 border-blue-200">
                      ...
                      <AlertDescription className="text-blue-900">
                        ...
                        <p className="text-sm mt-1">
                          Bridging the Aisle is limited to U.S. citizens. Because the platform
                          focuses on U.S. civic dialogue and political processes, participation is
                          restricted to U.S. citizens only. Verification may be requested.
                        </p>
                      </AlertDescription>
                    </Alert>
                  </motion.div>
                  ...
                  >
                      ...
                      <div className="mt-3 sm:mt-0 sm:ml-3">
                        <Link href="/auth/signin">
                          <Button
                            size="lg"
                            variant="outline"
                            className="w-full border-earth-brown-300 text-earth-brown-700 hover:bg-creamy-tan-100"
                          >
                            Sign In
                          </Button>
                        </Link>
                    ...
                    <div className="mt-4 sm:text-center lg:text-left">
                      <Link
                        href="/support"
                        className="text-sm font-medium text-turquoise-700 hover:text-turquoise-800 underline underline-offset-4"
                      >
        ...
        <div className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              <h2 className="text-base text-turquoise-600 font-semibold tracking-wide uppercase">
                Features
              </h2>
              ...
              <p className="mt-4 max-w-2xl text-xl text-earth-brown-600 lg:mx-auto">
                Our platform promotes constructive political discussions through innovative
                features designed to encourage civility and fact-based conversations. Whether
                you're discussing climate change policy, healthcare reform, economic issues,
                immigration, education, or foreign policy, our community brings together people
                of all political affiliations and perspectives for meaningful dialogue.
              </p>
            </div>
                    ...
                    <Card className="hover:shadow-lg transition-shadow duration-300 border-creamy-tan-200">
                      <CardHeader>
                        <div className="flex items-center space-x-3">
                          ...
                          <CardTitle className="text-lg text-earth-brown-800">
                            {feature.title}
                          </CardTitle>
                        </div>
                      </CardHeader>
        ...
        <div className="bg-pale-copper-50 py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              <h2 className="text-base text-pale-copper-600 font-semibold tracking-wide uppercase">
                Community Standards
              </h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-earth-brown-900 sm:text-4xl">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="border-creamy-tan-200">
                  ...
                  <CardContent>
                    <p className="text-earth-brown-600">
                      Treat all members with dignity regardless of political beliefs
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-creamy-tan-200">
                  ...
                  <CardContent>
                    <p className="text-earth-brown-600">
                      Back up claims with credible sources and evidence
                    </p>
                  </CardContent>
                </Card>
