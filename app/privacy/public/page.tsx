...
import { Shield, Database, Cookie, Eye, Lock, FileText, Mail, ArrowLeft } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  description: 'Your privacy matters - and so does your trust. We collect only what is needed to keep this space safe, functional, and fair. No selling, no trading, no renting your data - ever.',
}
    ...
    <div className="min-h-screen bg-gradient-to-br from-creamy-tan-50 to-creamy-tan-200">
      <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-6">
        ...
        <div className="flex justify-center gap-4 pt-4 pb-8">
          ...
          <Button asChild variant="outline">
            <Link href="/community-standards/public">Community Standards</Link>
          </Button>
        </div>
      </div>
    </div>
